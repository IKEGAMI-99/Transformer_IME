...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(TextView(this).apply {
            text = "Audio Pulseはキャプチャ可能なシステム再生音のRMSと瞬間ピークだけを解析します。無音時は黒。通常音量は青〜紫を中心に発光し、ピンク〜オレンジは大きなピーク時だけ出るように調整しています。v0.10.3ではリアルタイム値をメモリ共有に変更して描画負荷も軽くしました。"
            textSize = 13f
        ...
        root.addView(TextView(this).apply {
            text = "v0.10.3 構成\n" +
                ...
                "・123: 4×4数字キーパッドへ切替\n" +
                "・Audio Pulse: メモリ共有 / 高いピーク天井 / 下端光源\n" +
                "・下余白: gesture inset依存を廃止して最小化\n" +
                "・パスワード欄: AI・学習とも停止"
            textSize = 14f
